      ...
      <section class="content-section">
        ...
        <div class="table-wrapper">
          <table>
            <thead>
:              <tr>
                <th style="min-width: 140px; cursor: pointer;" onclick="sortTable('name')">Name <span class="sort-icon" data-column="name">↕️</span></th>
                <th style="min-width: 140px; cursor: pointer;" onclick="sortTable('book')">Book Title <span class="sort-icon" data-column="book">↕️</span></th>
                <th style="min-width: 95px; cursor: pointer;" onclick="sortTable('borrow')">Borrow Date <span class="sort-icon" data-column="borrow">↕️</span></th>
                <th style="min-width: 95px; cursor: pointer;" onclick="sortTable('due')">Due Date <span class="sort-icon" data-column="due">↕️</span></th>
                <th style="min-width: 95px; cursor: pointer;" onclick="sortTable('return')">Return Date <span class="sort-icon" data-column="return">↕️</span></th>
  ...
  <script>
    ...
    let currentSort = { column: 'borrow', direction: 'desc' };
    ...
    function sortTable(column) {
      ...
      document.querySelector(`.sort-icon[data-column="${column}"]`).classList.add(currentSort.direction);
    ...
    document.addEventListener('DOMContentLoaded', function() {
      // Set default sort icon to descending for Borrow Date
      const defaultIcon = document.querySelector('.sort-icon[data-column="borrow"]');
      if (defaultIcon) {
        defaultIcon.classList.add('desc');
      }
    });
  </script>
</body>
